...
\section{Problem}
Find the distance of the point $\myvec{-1\\-5\\-10}$ from the point of intersection of the line \vec{x} and the plane \\ 
 (1 -1 1).x = 5 
...
\vec{P} = \myvec{-1\\-5\\-10} and intersection point \myvec{2\\-1\\2}  = 13.
\begin{figure}[h]
	\centering
