...
\end{equation}
substitute (3.0.1) in (1.0.2) and so the value of 
\begin{equation} 
	\lambda = 0
\end{equation}
Substituting (3.0.2) in (3.0.1) so that we get equation of line as
\begin{equation}
	\vec{x} = \myvec{2\\-1\\2} 
\end{equation}
which is the intersection of line (1.0.1) and passes through point \myvec{2\\-1\\2}.
\\
