...
\section{Problem}
Find the distance of the point $\myvec{-1\\-5\\-10}$from the point of intersection of the line \begin{equation}\label{eq1}
	\frac{x-2}{3} = \frac{y+1}{4} = \frac{z-2}{2}
\end{equation} and the plane
\begin{equation} \myvec{1 -1 +1} \myvec{x} = 5 
\end{equation}
...
\begin{equation}
	\myvec{x} = \myvec{x_1\\y_1\\z_1} + \lambda\myvec{a\\b\\c}
\end{equation}
...
\begin{equation}
	\myvec{x} = \myvec{2\\-1\\2} + \lambda\myvec{3\\4\\2}
\end{equation}
...
\vec{P} = \myvec{-1\\-5\\-10} 
\end{equation}
Substituting (3.0.3) and (3.0.2) in (2.0.1) we get
\begin{equation}
	\vec{r} = \myvec{-1\\-5\\-10} + \lambda \myvec{3\\4\\2}
\end{equation}
which is the line parallel to line (1.0.1) and passes through point \myvec{2\\-1\\2}.
\\
Finally the distance between the point 
\vec{P} = \myvec{-1\\-5\\-10} and intersection point \myvec{2\\-1\\2} is
\begin{equation}
...
\begin{figure}[h]
	...
	\caption{Equation of line passing through point $P$ and parallel to line (1.0.1)}
	\label{fig:}
\end{figure}
